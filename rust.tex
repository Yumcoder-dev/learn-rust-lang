...
\begin{frame}[fragile]
	...
	\inputminted{rust}{./code/lifetime4.rs}
	 ...
	 The generic lifetime 'a will get the concrete \textbf{lifetime that is equal to the smaller of the lifetimes }of x and y. In practice, it means that the lifetime of the reference returned by the longest function is the same as the smaller of the lifetimes of the values referred to by the function arguments. These relationships are what we want Rust to use when analyzing this code.
\end{frame}


\begin{frame}[fragile]
	\frametitle{Lifetime Annotation Syntax (3)}
...
\end{frame}
 ...
 \begin{frame}[fragile]
 	\frametitle{Lifetime Annotation Syntax (4)}
