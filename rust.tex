...
\begin{document}
	...
	\begin{frame}[fragile]
		...
		\begin{itemize}
			...
			\item If you try to access an element of an array that is past the end of the array, you get a runtime error at the point of using an invalid value in the indexing operation.
		\end{itemize}
		\begin{block}{Note}
