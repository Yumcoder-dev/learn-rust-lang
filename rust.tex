...
\begin{frame}[fragile]
	...
	A more experienced Rustacean would write the signature shown in below instead because it allows us to use the same function on both \mintinline{rust}|&String|  values and  \mintinline{rust}|&str|  values.
\end{frame}
