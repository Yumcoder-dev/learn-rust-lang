...
\begin{frame}[fragile]
	...
	In the User struct definition, we used the owned String type rather than the \mintinline{rust}|&str| string slice type. This is a deliberate choice because we want each instance of this struct to own all of its data and for that data to be valid for as long as the entire struct is valid.
